                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <td><?php echo $row->templete_file;?></td>
                                        ...
                                        <td>
                                        <a href="templete-data.php?id=<?php echo $tid;?>" title="View Full Details"><i class="icon-size-fullscreen"></i></a> </td>
                                        <td><a href="manage-templete.php?del=<?php echo $tid;?>" title="Delete Record" onclick="return confirm('هل تريد حذف هذا');"><i class="icon-check" style="color:green;"></i></a></td>
                                        </tr>
                                            <?php
                                        $cnt=$cnt+1;
                                            } ?>
