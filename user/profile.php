<?php
    ...
    $query="UPDATE  userRegistration set firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=? where user_id=?";
...
//   unlink('../assets/images/users\\'.$row->image);
  ...
  $update = "UPDATE `userregistration` SET `image` = '$upphoto' WHERE `userregistration`.`user_id` = '$aid'";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h1 class="page-title text-truncate text-dark font-weight-medium mb-1">ملفي الشخصي</h1>
...
<!-- By CodeAstro - codeastro.com -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">رقم المستخدم</h4>
                                        <div class="form-group">
