<?php
    ...
    if(isset($_GET['del'])) {
        $id=intval($_GET['del']);
        $adn="DELETE from userregistration where user_id=?";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-subtitle">عرض جميع حسابات المستخدمين المسجلين..</h6>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-hover table-bordered no-wrap">
                                        ...
                                        <td><?php echo "<img src=' $image '  alt='user' width='40' height='40' >" ?></td>         <!-- image -->
                                        ...
                                        echo "مفعل";}else {
                                            ...
                                            <td>
                                            <a href="edit-users.php?user_id=<?php echo $row->user_id;?>" title="تعديل المستخدم"><i class="icon-note"></i></a>&nbsp;&nbsp;
                                            <a href="acc-setting_user.php?user_id=<?php echo $row->user_id;?>" title="تغيير كلمة المرور"><i class="icon-key" style="color:green;"></i></a>&nbsp;&nbsp;
                                                <a href="view-users-acc.php?del=<?php echo $row->user_id;?>" title="حذف المستخدم" onclick='return confirm("هل تريد حذف حساب المستخدم");'><i class="icon-close" style="color:red;"></i></a>
                                            </td>
                                        </tr>
                                            <?php
                                        $cnt=$cnt+1;
