<?php
   ...
   // $gender=$_POST['gender'];
    ...
    $query="UPDATE userRegistration set option=? where user_id=?";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('si',$option,$id);
    $stmt->execute();
    echo"<script>alert('تم التحديث بنجاح');
    window.location.href='view-users-acc.php';
    </script>";
    }
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">تعديل بيانات المستخدم</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">رقم الهاتف</h4>
                                        <div class="form-group">
                                            <input type="number" name="contact" value="<?php echo $row->contactNo;?>" id="contact" placeholder="رقم الهاتف" required="required" class="form-control" disabled class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
