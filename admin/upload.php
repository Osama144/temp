...
//تعريف التطبيق   
      ...
      $s = $x['size'] / 1024 ." kb";
      echo $t, $s."Kb<br> "  ;
      $sql1="insert into templetes(templete_name,templete_desc,templete_file,image,templete_date,m_cat_id,size,admin_id)values('$templete_name','$templete_desc','$file_new_name','$image_new_name','$udate','$m_cat_id','$s','$user_id')";
