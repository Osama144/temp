...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <header class="topbar" data-navbarbg="skin6" style='width: 115%;margin-right: -260px;'><!-- وصلنا هنا الاثنين-->
                ...
                <div class="card-group">
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/booked-count2.php'?></h2>
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">الأخبار غير مفعلة</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">الأخبار المفعلة</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i data-feather="book-open"></i></span>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium"><?php include 'counters/messages-count.php'?></h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate"> الرسائل الجديدة</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
