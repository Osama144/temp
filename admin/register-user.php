<?php
    ...
    $query="INSERT into userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password,option) values(?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssssisss',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$password,$option);
    $stmt->execute();
        echo"<script>alert('تم تسجيل المستخدم!');</script>";
    }
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">استمارة تسجيل المستخدمين </h4>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">رقم تسجيل المستخدم</h4>
                                        <div class="form-group">
                                            <input type="text" name="regno" placeholder="رقم تسجيل المستخدم" id="regno" class="form-control" required>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">الاسم</h4>
                                        <div class="form-group">
                                            <input type="text" name="fname" id="fname" placeholder="اسم المستخدم" required class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">كلمة المرور</h4>
                                        <div class="form-group">
                                            <input type="password" name="password" id="password" placeholder="كلمة المرور" required="required"  minlength="9" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">تاكيد كلمة المرور</h4>
                                        <div class="form-group">
                                            <input type="password" name="cpassword" id="cpassword" placeholder="تاكيد كلمة المرور" required="required"  minlength="9" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="text-center">
                                <button type="submit" name="submit" class="btn btn-success">تسجيل المستخدم</button>
